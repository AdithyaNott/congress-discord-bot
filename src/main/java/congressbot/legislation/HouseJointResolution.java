...
public class HouseJointResolution extends CongressBill implements Vetoable {
    private static final String EXPLANATION = "An H.J.Res. is a joint resolution originating from the House of Representatives. They are generally the same as bills in that they require approval of both chambers of Congress and the president's signature (or if vetoed by the president, 2/3 of both chambers of Congress overriding the veto) to become a law. A notable exception is Joint Resolutions that are proposing Constitutional Amendments, which require 2/3 approval from both chambers of Congress and 3/4 of the states, but do not require the president's signature.";

    public HouseJointResolution(CongressBill.CongressBillBuilder cb) {
